          ...
          >
            ...
            <div className="relative">
              ...
              <div className="absolute top-4 right-4">
                <span
                  className={`${
                    spain.activelisting ? "bg-green-600" : "bg-red-600"
            ...
            <div className="p-6">
              <div className="mb-4">
                <span className="text-2xl font-bold">
                  ${spain.propertyprice.toLocaleString()}
                </span>
              </div>
              ...
              <div className="flex items-center gap-4 text-gray-500">
                ...
                <div className="flex items-center">
                  ...
                  {spain.category.includes("spain") ? "Spain" : "Spain"}
                </div>
              </div>
            </div>
          </div>
